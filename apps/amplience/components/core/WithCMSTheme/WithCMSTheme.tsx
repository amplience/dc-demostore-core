...
const WithCMSTheme: FC<{
  ...
  if (CMSTheme) {
    palette = CMSTheme?.children?.find(
      (node) => node.content.type === "Palette"
    );
    typography = CMSTheme?.children?.find(
      (node) => node.content.type === "Typography"
    );
  }
  ...
  const theme = createTheme({
    ...
    typography: {
      ...
      fontWeightRegular: typography
        ? typography.content.fontWeightRegular
        : 400,
      ...
      h2: {
        ...
        fontFamily: typography
          ? typography.content.h2.fontFamily
          : "'Montserrat', sans-serif",
        fontWeight: typography ? typography.content.h2.fontWeight : 400,
        textTransform: typography
          ? typography.content.h2.textTransform
          : "uppercase",
      },
      h3: {
        ...
        fontFamily: typography
          ? typography.content.h3.fontFamily
          : "'Roboto Condensed', sans-serif",
        fontWeight: typography ? typography.content.h3.fontWeight : 700,
        textTransform: typography
          ? typography.content.h3.textTransform
          : "uppercase",
      },
      h4: {
        ...
        fontFamily: typography
          ? typography.content.h4.fontFamily
          : "'Roboto Condensed', sans-serif",
        fontWeight: typography ? typography.content.h4.fontWeight : 400,
        textTransform: typography
          ? typography.content.h4.textTransform
          : "none",
      },
      h5: {
        ...
        fontFamily: typography
          ? typography.content.h5.fontFamily
          : "'Roboto Condensed', sans-serif",
        fontWeight: typography ? typography.content.h5.fontWeight : 400,
        textTransform: typography
          ? typography.content.h5.textTransform
          : "none",
      },
      h6: {
        ...
        fontFamily: typography
          ? typography.content.h6.fontFamily
          : "'Roboto Condensed', sans-serif",
        fontWeight: typography ? typography.content.h6.fontWeight : 400,
        textTransform: typography
          ? typography.content.h6.textTransform
          : "none",
      },
      subtitle1: {
        ...
        fontFamily: typography
          ? typography.content.subtitle1.fontFamily
          : "'Roboto Condensed', sans-serif",
        fontWeight: typography ? typography.content.subtitle1.fontWeight : 700,
        textTransform: typography
          ? typography.content.subtitle1.textTransform
          : "none",
      },
      subtitle2: {
        ...
        fontFamily: typography
          ? typography.content.subtitle2.fontFamily
          : "'Roboto Condensed', sans-serif",
        fontWeight: typography ? typography.content.subtitle2.fontWeight : 400,
        textTransform: typography
          ? typography.content.subtitle2.textTransform
          : "none",
      },
      body1: {
        ...
        fontFamily: typography
          ? typography.content.body1.fontFamily
          : "'Roboto Condensed', sans-serif",
        fontWeight: typography ? typography.content.body1.fontWeight : 400,
        textTransform: typography
          ? typography.content.body1.textTransform
          : "none",
      },
      body2: {
        ...
        fontFamily: typography
          ? typography.content.body2.fontFamily
          : "'Roboto Condensed', sans-serif",
        fontWeight: typography ? typography.content.body2.fontWeight : 400,
        textTransform: typography
          ? typography.content.body2.textTransform
          : "none",
      },
      button: {
        ...
        backgroundColor: "#999",
        fontFamily: typography
          ? typography.content.button.fontFamily
          : "'Roboto Condensed', sans-serif",
        fontWeight: typography ? typography.content.button.fontWeight : 400,
        textTransform: typography
          ? typography.content.button.textTransform
          : "none",
      },
      caption: {
        ...
        fontFamily: typography
          ? typography.content.caption.fontFamily
          : "'Roboto Condensed', sans-serif",
        fontWeight: typography ? typography.content.caption.fontWeight : 400,
        textTransform: typography
          ? typography.content.caption.textTransform
          : "none",
        fontStyle: "italic",
      },
      overline: {
        ...
        fontFamily: typography
          ? typography.content.overline.fontFamily
          : "'Roboto Condensed', sans-serif",
        fontWeight: typography ? typography.content.overline.fontWeight : 400,
        textTransform: typography
          ? typography.content.overline.textTransform
          : "none",
      },
    },
  });
