...
function Sitemap({
  ...
  content,
  params
}: InferGetServerSidePropsType<typeof getServerSideProps> & WithStyles<typeof styles>) {
      ...
      <div className={classes.links}>
        {
          sections.map(section => {
            return <div key={nanoid()}>
              <a href={`${section.href}${urlSuffix}`} target="_blank" rel="noreferrer">
                <Typography variant="h4" component="h3" className={classes.section}>{section.title}</Typography>
              </a>
...
let component = withStyles(styles)(Sitemap);
