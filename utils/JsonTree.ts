...
export class JsonTree {
    public static visit(data: any, visitor: JsonVisitor, depth: number = 0): void {
        if (depth > 1000) {
    ...
    public static async asyncVisit(data: any, visitor: (value: any) => Promise<any>, depth: number = 0): Promise<void> {
        if (depth > 1000) {
            throw new Error('Tree depth exceeded maximum of 1000, verify the data is not self-referential');
        }
