        ...
        <footer className="footer">
            ...
            <section className="footer__signup">
              ...
              <div className="footer__signup-input-wrap">
                <input type="text" placeholder={props.newsletterPlaceholderText || "Sign up for ANYA FINN news..."}/>
            ...
            <section className="footer__watermark">
              <Typography variant="h6" component="h6">{props.copyrightNoticeText || "Copyright 2020 ANYA FINN"}</Typography>
            </section>
        </footer>
    );
}
