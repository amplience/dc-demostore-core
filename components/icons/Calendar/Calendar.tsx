...
export default function Calendar({className}: any) {
    return (
        <svg width="1em" height="1em" viewBox="0 0 16 16" className={clsx("bi bi-calendar3", className)} fill="currentColor" xmlns="http://www.w3.org/2000/svg">
