...
const Template = (key: string) => {
    return (args: any) => {
        const overrideContent = (content: any) => {
            content.textPositioning.textPositionHorizontal = args.textPositionHorizontal
                ? args.textPositionHorizontal
                : 'right';
            content.textPositioning.textPositionVertical = args.textPositionVertical
                ? args.textPositionVertical
                : 'middle';
