  ...
  return (
    <StyledEngineProvider injectFirst>
      ...
      <div className={classes.root}>
        <Typography className={classes.typo} variant="h1" component="h1">{`Heading 1 (H1) - ${props.h1.fontFamily}; font-size: ${props.h1.fontSize};`}</Typography>
        <Typography className={classes.typo} variant="h2" component="h2">{`Heading 2 (H2) - ${props.h2.fontFamily}; font-size: ${props.h2.fontSize};`}</Typography>
        <Typography className={classes.typo} variant="h3" component="h3">{`Heading 3 (H3) - ${props.h3.fontFamily}; font-size: ${props.h3.fontSize};`}</Typography>
        <Typography className={classes.typo} variant="h4" component="h4">{`Heading 4 (H4) - ${props.h4.fontFamily}; font-size: ${props.h4.fontSize};`}</Typography>
        <Typography className={classes.typo} variant="h5" component="h5">{`Heading 5 (H5) - ${props.h5.fontFamily}; font-size: ${props.h5.fontSize};`}</Typography>
        <Typography className={classes.typo} variant="h6" component="h6">{`Heading 6 (H6) - ${props.h6.fontFamily}; font-size: ${props.h6.fontSize};`}</Typography>
        <Typography className={classes.typo} variant="subtitle1" component="p">{`Subtitle 1 (S1) - ${props.subtitle1.fontFamily}; font-size: ${props.subtitle1.fontSize};`}</Typography>
        <Typography className={classes.typo} variant="subtitle2" component="p">{`Subtitle 2 (S2) - ${props.subtitle2.fontFamily}; font-size: ${props.subtitle2.fontSize};`}</Typography>
        <Typography className={classes.typo} variant="body1" component="p">{`Body 1 (B1) - ${props.body1.fontFamily}; font-size: ${props.body1.fontSize};`}</Typography>
        <Typography className={classes.typo} variant="body2" component="p">{`Body 2 (B2) - ${props.body2.fontFamily}; font-size: ${props.body2.fontSize};`}</Typography>
        <Typography className={classes.typo} variant="button" component="button">{`Button 2 (BU) - ${props.button.fontFamily}; font-size: ${props.button.fontSize};`}</Typography>
        <Typography className={classes.typo} variant="caption" component="p">{`Caption (CA) - ${props.caption.fontFamily}; font-size: ${props.caption.fontSize};`}</Typography>
        <Typography className={classes.typo} variant="overline" component="p">{`overline (O) - ${props.overline.fontFamily}; font-size: ${props.overline.fontSize};`}</Typography>
      </div>
      </ThemeProvider>
    </StyledEngineProvider>
  );
}
export default withStyles(styles)(ThemeTypographySpec);